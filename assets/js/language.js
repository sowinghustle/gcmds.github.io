...
var languageStrings = {
  PT: {
    ...
    main_section_about_me_description:
      "Meu nome é Guilherme, tenho 19 anos e sou um aluno da faculdade de tecnologia (Fatec) de Presidente Prudente. Eu possuo um gosto por front-end, e procuro me desenvolver cada vez mais!",
    projects_section_title: "Meus Projetos",
    project1_title: "Wany",
    project1_description:
      "Site onde desenvolvedores indies podem publicar seus jogos que estarão acessíveis a outros usuários. Participei no desenvolvimento e fiquei responsável por grande parte das decisões visuais e o front-end de algumas páginas.",
    ...
    project3_description:
      "Um projeto simples de construção de uma calculadora utilizando a biblioteca front-end JS - React e css vanilla.",
    project4_title: "Jogos RPG Maker",
    project4_description:
      'Alguns jogos feitos na Engine de desenvolvimento de jogos "GameMaker Studio 2" enquanto eu a estudava. Todos sprites também foram feitos por mim, utilizando o software Aseprite.',
    project5_title: "Programa Login e Cadastro C#",
    project5_description:
      "Programa simples de login e cadastro de usuários com conexão a banco de dados, feito em C# utilizando windows form.",
  ...
  EN: {
    ...
    project1_title: "Wany",
    project1_description:
      "Site where indie developers can publish their games that will be accessible to other users. I took part in the development and was responsible for most of the visual decisions and the front-end of some pages.",
    button_acess: "Acess",
    project2_title: "Site SWAPI",
    project2_description:
      "Simple website for consuming the SWAPI (The Star Wars API) with a front-end presentation using vanilla CSS and PHP working on the back-end.",
    project3_title: "Calculator in React",
    project3_description:
      "A simple project to build a calculator using the front-end JS library - React and vanilla css.",
    project4_title: "RPG Maker Games",
    project4_description:
      'Some games made in the game development engine "GameMaker Studio 2" while I was studying it. All sprites were also made by me, using the Aseprite software.',
    project5_title: "Login and Signup Program in C#",
    project5_description:
      "Simple program for login and user registration with database connection, made in C# using windows form.",
    ...
    contact_other_platforms:
      "Or you can hit me up on some of my other platforms!",
    contact_section_linkedln: "Linkedln",
    contact_section_twitter: "Twitter",
    contact_section_instagram: "Instagram",
  },
